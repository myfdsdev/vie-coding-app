...
// Each test spawns several git processes, which is slow on Windows when many test files run at once.
...
describe('checkpoints', () => {
  it(
    'starts with the template and commits one version per change',
    async () => {
  ...
  it(
    'restores an old version as a new one, removing files added since',
    async () => {
  ...
  it(
    'rejects anything that is not a version of this project',
    async () => {
